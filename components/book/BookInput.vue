<template>
  <div class="flex">
    ...
    <button
      @click="search"
      class="w-3/12 py-2 ml-2 rounded border border-gray-300 bg-indigo-500 hover:bg-indigo-600 transition-all duration-200 disabled:bg-gray-400 disabled:text-white"
    >
      search
    </button>
  </div>
